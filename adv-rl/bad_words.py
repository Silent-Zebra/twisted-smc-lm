...
from custom_transformer_prob_utils import get_log_p_all_tokens
...
def calc_analytic_bad_word_probs(n_vocab, prompt, params_p, huggingface_model, batch_size=512):
    ...
    return total_prob_bad_t_0_by_word, total_prob_bad_t_0
