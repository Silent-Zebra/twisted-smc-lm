...
def rl_loss_custom_baselinep(sk, prompt, cfg_p, params_p, cfg_twist, params_twist, log_true_final_twist,
                rew_model, output_len, n_samples, prompt_len, cfg_baseline, params_baseline,
                cfg_p_0, params_p_0, beta_kl, beta_ent, analytic_sigma_sample, n_vocab):
    sk, sk2, sk3 = jax.random.split(sk, 3)
    _, prompt_w_sigma_sample_s_1_to_t = smc_procedure(sk, prompt,
...
def rl_loss_custom_mixed_sampling(sk, prompt, cfg_p, params_p, cfg_twist, params_twist, log_true_final_twist,
                rew_model, output_len, n_samples, prompt_len, cfg_baseline, params_baseline,
                cfg_p_0, params_p_0, beta_kl, beta_ent, analytic_sigma_sample, n_vocab):
    sk, sk2, sk3 = jax.random.split(sk, 3)
    _, prompt_w_sigma_sample_s_1_to_t = smc_procedure(sk, prompt,
...
def rl_loss_custom_extremes(sk, prompt, cfg_p, params_p, cfg_twist, params_twist, log_true_final_twist,
                rew_model, output_len, n_samples, prompt_len, cfg_baseline, params_baseline,
                cfg_p_0, params_p_0, beta_kl, beta_ent, cfg_twist_pos,
                            params_twist_pos, log_true_final_twist_pos, analytic_sigma_sample, n_vocab):
