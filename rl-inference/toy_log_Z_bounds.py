...
class ExperimentConfig:
        ...
        if self.twist_learn_type == "analytic_mse_rel" or self.twist_learn_type == "analytic_mse_abs":
            ...
            if self.train_on_true_posterior_samples:
                ...
                if self.twist_learn_type in ["ebm_ml_jit_vmapped_over_condition_tokens", "ebm_ml_jit_vmapped_over_condition_tokens_nosmcub", "ebm_ml_pprop_jit_vmapped_over_condition_tokens_nosmcub",
                                             "ebm_ml_pprop_jit_vmapped_over_condition_tokens", "ebm_ml_vmap_with_one_total_kl"]:
    ...
    def update_twist(self, rng_key, indices_of_tokens_chosen, prompt, n_twist,
        ...
        if self.rm_type == "indicator_at_index" or self.rm_type == "p_token_last_index":
            ...
            # print("UPDATE TIME:")
            # print(time.time() - new_time)
        # elif self.rm_type in ["p_last_tokens"]:
        #     rng_key, sk = jax.random.split(rng_key)
        #     grad_params_twist = self.get_grad_params_twist(
        #         sk, prompt, self.n_vocab, n_twist,
        #         output_len, cfg_p, params_p, cfg_twist,
...
if __name__ == "__main__":
    ...
    if args.twist_learn_type in ["ebm_ml_jit_vmapped_over_condition_tokens", "ebm_ml_jit_vmapped_over_condition_tokens_nosmcub",
