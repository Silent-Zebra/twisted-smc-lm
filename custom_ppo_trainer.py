# Source: https://github.com/huggingface/trl/blob/main/trl/trainer/ppo_trainer.py
...
import custom_trl_model

if is_deepspeed_available():
    import deepspeed

SUPPORTED_ARCHITECTURES = (*SUPPORTED_ARCHITECTURES, custom_trl_model.CustomAutoModelForCausalLMWithValueHead)
    ...
    def generate(
        ...
        **generation_kwargs,
        ...
        if isinstance(query_tensor, List):
            ...
            raise NotImplementedError # I haven't set up generation here properly
