...
def get_log_true_final_twists(
    ...
    # TypeError: ToxicityThresholdTwistBuilder.__init__() got an unexpected keyword argument 'reward_cap'
...
def f_exploration_rm(first_words_index_of_token_list, second_words_index_of_token_list, beta_temp=1.):
    def new_rm(seq):
        ...
        for ind_of_token in first_words_index_of_token_list:
